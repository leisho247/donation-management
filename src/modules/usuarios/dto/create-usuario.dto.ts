...
export class CreateUsuarioDto {
  ...
  @ApiProperty({ description: 'Email del usuario (único)', example: 'usuario@example.com' })
  @IsEmail({}, { message: 'El email debe ser una dirección de correo válida.' })
  @IsNotEmpty({ message: 'El email no puede estar vacío.' })
  @MaxLength(255, { message: 'El email no puede exceder los 255 caracteres.' })
  email: string;

  @ApiProperty({ description: 'Contraseña del usuario (texto plano, se hashea en el backend)', example: 'passwordSeguro123' })
